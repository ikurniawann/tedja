-- Menu POS → Laporan → Rush Hour.
-- Pola grant sama laporan Transaksi: ikut siapa pun yang punya Profit.

INSERT INTO iam.menus (code, menu_name, route_path, icon, menu_type, order_number, permission_context)
VALUES ('pos.reports.rush-hour', 'Rush Hour', '/dashboard/pos/reports/rush-hour',
        'clock', 'sidebar', 26, '{"actions":["read"]}'::jsonb)
...
UPDATE iam.menus SET module = 'pos', level = 3 WHERE code = 'pos.reports.rush-hour';
UPDATE iam.menus child SET parent_id = parent.id
FROM iam.menus parent
WHERE child.code = 'pos.reports.rush-hour' AND parent.code = 'pos.reports';
...
WHERE m_new.code = 'pos.reports.rush-hour'
  AND rmp.is_active
