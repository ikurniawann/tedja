-- =============================================================================
-- IAM: Journal History (inquiry POSTED journals) under Accounting
-- =============================================================================

INSERT INTO iam.menus (code, menu_name, route_path, icon, menu_type, order_number, permission_context)
VALUES
  ('accounting.journal-history', 'Journal History',
   '/dashboard/accounting/journal-history', 'document-magnifying-glass', 'sidebar', 36,
...
WHERE child.code = 'accounting.journal-history'
...
WHERE r.code IN ('super_admin', 'admin')
  AND m.code = 'accounting.journal-history'
