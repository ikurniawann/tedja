...
INSERT INTO iam.menus (code, menu_name, route_path, icon, menu_type, order_number, permission_context) VALUES
  ...
  ('hris.users', 'Karyawan', '/dashboard/employees', 'users', 'sidebar', 8, '{"actions":["read"]}'::jsonb),
  ('hris.contracts', 'Kontrak', '/dashboard/hris/contracts', 'file-text', 'sidebar', 9, '{"actions":["read"]}'::jsonb),
