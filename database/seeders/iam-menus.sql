...
INSERT INTO iam.menus (code, menu_name, route_path, icon, menu_type, order_number, permission_context) VALUES
  ...
  ('accounting.accounts-payable', 'Account Payable', '/dashboard/accounting/accounts-payable', 'banknotes', 'sidebar', 39, '{"actions":["read","create","update"]}'::jsonb)
