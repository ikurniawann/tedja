...
- **Table-order & Photobooth** (`/table-order/[tableCode]`, `/photobooth/self-service`) = app self-service standalone, masih **prototipe** (state klien, menu hardcode) — verifikasi wiring backend sebelum diandalkan.
