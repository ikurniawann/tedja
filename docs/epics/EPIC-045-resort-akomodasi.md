...
Dirilis ke production 2026-09-07 atas permintaan owner, **tanpa data contoh**
— seeder demo (venue utama & tenant Dusun Bambu) sengaja tetap tinggal di
branch `development` dan tidak pernah ikut ke sini.
