  ...
  return (
    <div className="space-y-6">
      <PurchasingFormHeader
        ...
        description="Upload CSV or Excel to add suppliers, or re-import an exported file to update existing records."
        actions={
          <Button
            type="button"
            variant="outline"
          ...
          <CardContent className="flex min-h-0 flex-1 flex-col space-y-4 p-4">
            <div className="flex shrink-0 items-start gap-3 rounded-lg border border-gray-200/70 bg-gray-50/80 p-4">
              ...
              <div className="text-sm text-gray-600">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-4">
                  <li>
                    Export from the supplier list, edit fields, then re-import the same file.
                  </li>
                  <li>Existing codes are updated; empty code creates a new supplier.</li>
                  <li>Supported formats: CSV and Excel (.xlsx).</li>
                  <li>Required column: supplier name (<strong>nama_supplier</strong>).</li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex min-h-0 flex-1 flex-col">
              <CsvImporter
                ...
                title="Import Suppliers"
                description="Upload CSV or Excel to add suppliers in bulk."
